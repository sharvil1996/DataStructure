...
public class Temppp {
	...
	public ArrayList<Integer> repeatedNumber(final List<Integer> a) {
		...
		for (int i = 0; i < a.size(); i++) {
			if (a.get(Math.abs(a.get(i)) - 1) > 0) {
				a.set(Math.abs(a.get(i)) - 1, a.get(Math.abs(a.get(i)) - 1) * -1);
			} else {
				returnvalue.add(Math.abs(a.get(i)));
			}
		}
	...
	public static void main(String[] args) {
		...
		int i[] = { 389, 299, 65, 518, 361, 103, 342, 406, 24, 79, 192, 181, 178, 205, 38, 298, 218, 143, 446, 324, 82,
		 ...
		 * long max = 141778;
		 * 
		 * for (int j = 0; j < i.length; j++){ max -= i[j];
		...
		/*
		 * a.add(3); a.add(1); a.add(2); a.add(5); a.add(1);
		 * 
		 * System.out.println(a.containsAll(a));
		 * 
		for (int j = 0; j < i.length; j++) { a.add(i[j]); }
		 */
		for (int j = 0; j < i.length; j++) { a.add(i[j]); }
		/*a.add(7);
		a.add(3);
		...
		a.add(6);
		a.add(2);*/
		System.out.println(a.size() + " " + i.length);
		new Temppp().repeatedNumber(a);
	}
}
